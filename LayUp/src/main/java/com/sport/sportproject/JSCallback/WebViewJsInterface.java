...
import com.sport.sportproject.ui.fragment_match.net.HtmlUtil;
...
//    String getHostsList();
    ...
    class BaseWebViewJsInterface implements WebViewJsInterface {
        ...
        public String replaceAdsParams(String url) {
            return HtmlUtil.replaceAdsUrlParams(BaseApp.getInstance(), url);
        }
        ...
        public String getDeviceInfo() {
            ...
            Map<String, String> params = HtmlUtil.getAdsParams(BaseApp.getInstance(), 1);
