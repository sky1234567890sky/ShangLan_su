...
public class CountDownTimerUtils extends CountDownTimer {
  ...
  public void onTick(long millisUntilFinished) { 
    ...
    mTextView.setTextColor(ContextCompat.getColor(BaseApp.getInstance(),R.color.c_8a8a8a)); //设置按钮为灰色，这时是不能点击的
  ...
  public void onFinish() { 
    ...
    mTextView.setTextColor(ContextCompat.getColor(BaseApp.getInstance(),R.color.c_e34536));
  } 
}