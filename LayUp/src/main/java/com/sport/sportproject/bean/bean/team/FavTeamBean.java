package com.sport.sportproject.bean.bean.team;
...
public class FavTeamBean implements Parcelable {


    protected FavTeamBean(Parcel in) {
        team_list = in.createTypedArrayList(FavTeamBean.CREATOR);
        viewType = in.readInt();
        list = in.createTypedArrayList(FavTeamBean.CREATOR);
        title = in.readString();
        name = in.readString();
        logo = in.readString();
    ...
    public static final Creator<FavTeamBean> CREATOR = new Creator<FavTeamBean>() {
        @Override
        public FavTeamBean createFromParcel(Parcel in) {
            return new FavTeamBean(in);
        }

        @Override
        public FavTeamBean[] newArray(int size) {
            return new FavTeamBean[size];
        }
    };
     ...
     * selected_teams : ["1","16"]
     */
    private ArrayList<FavTeamBean> team_list;
    ...
    public void setTeam_list(ArrayList<FavTeamBean> team_list) {
    ...
    public ArrayList<FavTeamBean> getTeam_list() {
        return team_list;
    }
     ...
     * title : 热门
     */
    private ArrayList<FavTeamBean> list;
    private String title;

    public void setList(ArrayList<FavTeamBean> list) {
        this.list = list;
    }
    ...
    public ArrayList<FavTeamBean> getList() {
        return list;
    }
